 ...
 *
 * $Id: ReadByMappingDescriptorExample.java 6220 2017-08-24 12:23:59Z tkn $
 */
...
public abstract class ReadByMappingDescriptorExample {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try (ReadRequest request =
             ...
             * "LastName"
             */
            IQueryResult result = request.readLogicalBy(LASTNAME_FIELD);
