...
public abstract class Delete {
	...
	public static void main(final String[] args) throws Exception {
		try {
			AdabasConnection connection = AdabasConnection.createSession("acj:map=CUSTOMERS,NEW_MAP;config=[103,11]");
			DeleteRequest deRequest = connection.createDeleteRequest();
			deRequest.deleteRecord(10025);
			deRequest.endTransaction();
			deRequest.close();
			connection.close();
		} catch (Exception e) {
