...
public abstract class Store {
	...
	public static void main(final String[] args) throws Exception {
		try {
			...
			entry.addValue("CUSTID","F1002");
			entry.addValue("FIRSTNAME","FRITZ");
			entry.addValue("LASTNAME","FLACH");
			entry.addValue("PHONE","001",1);
			entry.addValue("PHONE","002",2);
			entry.addValue("PHONE","003",3);
			Long[] isns = stRequest.storeEntry(entry);
			System.out.println("New ISN = "+isns[0].longValue());
